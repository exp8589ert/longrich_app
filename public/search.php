...
if(isset($_POST['searchPara']) && $_POST['searchPara'] !== '') {
	$fmSearch = filter_var(strip_tags($_POST['searchPara']), FILTER_SANITIZE_SPECIAL_CHARS);
	$usersPost = $showDATA->forumUserSearch($fmSearch);
	$resultCount = count($usersPost);
...
<a href="#" class="facebook-share " onclick='window.open("https:www.facebook.com/sharer/sharer.php?u=http://findmatthew.com&quote=Work and earn reasonably at your own pace.", "Facebook Share", "facebook-share-dialog", "width=620, height=420"); return false;'>
...
<a href="#" onclick='window.open("https:www.twitter.com/share?url=http://localhost:81/longrichs.com/forum.php&via=Sitename&text=Work and earn reasonably at your own pace.", "Twitter Share", "width=620, height=420"); return false;'>
<i class="fas fa-share-alt edit"></i> 
&nbsp;Share on Twitter 
...
<a href="javascript:void(0);">&nbsp;&nbsp;Share on Pinterest <img class="pinterest edit">
<i class="pin-share fas fa-share-alt edit"></i> 
</a>

<a data-pin-do="buttonPin" href="https://www.pinterest.com/pin/create/button/?url=http://localhost:81/longrichs.com/forum.php&media=http://localhost:81/longrichs.com/resources/images/why3.png&description=Work and earn reasonably at your own pace.">
</a>
</li>
...
if(!empty($postimage)) {
echo '<img src="'.$postimage.'" class="post-img fmedia-holder media-holder">';
}
...
echo '<div class="searched-result">Other related results ... </div>';
